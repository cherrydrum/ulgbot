...
now = datetime.datetime.now()
date = u'{} {}'.format(now.day, months[now.month - 1])
draw.text((40, 30),u'Расписание уроков на {}.'.format(date),(41,41,41),font=ImageFont.truetype("header.ttf", 30))
...
#Конец сценария, сохранение базы
